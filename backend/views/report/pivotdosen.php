...
$this->title = 'Pivot Dosen';
$this->params['breadcrumbs'][] = ['label' => 'Report', 'url' => ['pivotdosen']];
$this->params['breadcrumbs'][] = 'Pivot Dosen';
...
<div class="row">
    ...
    <div class="col-md-12">
        <table id="dg_report" class="easyui-datagrid" title="Report - Pivot Dosen"></table>
    </div>
</div>
...
$this->registerJsFile(
    '@web/script/report_pivotdosen.js',
    ['depends' => [\yii\web\JqueryAsset::className()]]
);?>
